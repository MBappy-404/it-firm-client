     ...
     return (
          <div className=' px-2 md:px-12 py-10'>
                <h2 className='text-5xl font-bold text-center'>Why Chose Us</h2>
                   <p className=" text-md text-center py-8 font-semibold text-gray-500 md:text-md">
        We Are Offering All Kinds of IT Solutions Services.We Are Dedicated To Serve You All Time. It is a long established
fact <br /> that a reader will be distracted by the readable content of a page when looking at its layout.
        </p>
               <ul
        ...
        <section
          ...
          >
            <div class="  text-center sm:text-left">
              <div class="pt-10   text-gray-200 sm:text-xl">

  ...
  return (
    <div className='pt-16 bg-gray-100'>
      ...
      <div>
        ...
        <p className='text-md text-center py-4 font-semibold text-gray-500'>We Are Offering All Kinds of IT Solutions Services.We Are Dedicated To Serve You All Time.  It is a long established <br /> fact that a reader will be  distracted by the readable content of a page when looking at its layout. </p>
      </div>
